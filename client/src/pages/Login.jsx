...
export const Login = () => {
  ...
  return (
    <div className="w-full h-[700px] md:h-screen flex justify-center items-center bg-slate-300 dark:bg-slate-900 overflow-hidden relative transition-colors duration-500">
      <div className="animate-fadeIn w-full h-full flex justify-center items-center">
        ...
        <form
          className="flex flex-col justify-between items-center dark:bg-slate-800 bg-slate-200 p-6 w-96 h-[550px] rounded-md transition-colors duration-500"
