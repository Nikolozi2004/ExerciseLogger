...
import { EnvelopeIcon, EyeIcon, EyeSlashIcon, ArrowLeftCircleIcon, SunIcon, MoonIcon } from "@heroicons/react/24/solid"
...
export const Register = () => {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-slate-300 dark:bg-slate-900 overflow-hidden relative transition-colors duration-500">
      ...
      <form className="flex flex-col justify-between items-center dark:bg-slate-800 bg-slate-200 p-6 w-96 h-4/6 rounded-md transition-colors duration-500"
